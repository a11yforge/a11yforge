...
public class FixProposalServiceTest {
    ...
    public void verifiedFixSaved() {
        ...
        ViolationDto target = new ViolationDto(
                ...
                List.of(), "", "", "", List.of("img"), "<img>", null);

        FixProposal result = fixProposalService.generateAndVerify(
                violation, "<html>", List.of(target), List.of("image-alt"),
                new NoOpChatProvider(), target);
